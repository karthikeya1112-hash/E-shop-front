...
const CartPage = () => {
  ...
  const getData = async () => {
    try {
      const res = await fetch("https://e-shop-wepb.onrender.com/carts", {
        headers: {
  ...
  const handleInc = (itemId: any) => {
    ...
    fetch(`https://e-shop-wepb.onrender.com/carts/update/${itemId._id}`, {
      method: "PATCH",
      headers: {
        Authorization: `${localStorage.getItem("e-book token")}`,
        "Content-Type": "application/json",
  ...
  const handleRemoveItem = (itemId: any) => {
    ...
    setCartItems(updatedCartItems);
    fetch(`https://e-shop-wepb.onrender.com/carts/delete/${itemId._id}`, {
      method: "DELETE",
      headers: {
        Authorization: `${localStorage.getItem("e-book token")}`,
      },
