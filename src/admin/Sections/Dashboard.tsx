...
export default function Dashboard() {
  ...
  const getDataElectronic = async () => {
    await axios
      .get(`https://e-shop-wepb.onrender.com/electronics`)
  ...
  const getDataMens = async () => {
    await axios
      .get(`https://e-shop-wepb.onrender.com/mens`)
      .then((res: AxiosResponse) => {
  ...
  const getDataWomens = async () => {
    await axios
      .get(`https://e-shop-wepb.onrender.com/womens`)
      .then((res: AxiosResponse) => {
  ...
  const getDataKid = async () => {
    await axios
      .get(`https://e-shop-wepb.onrender.com/kids`)
      .then((res: AxiosResponse) => {
